...
**%lu** 为 32 位无符号整数，详细说明查看 [C 库函数 - printf()](http://www.runoob.com/cprogramming/c-function-printf.html)。
...
**%E** 为以指数形式输出单、双精度实数，详细说明查看 [C 库函数 - printf()](http://www.runoob.com/cprogramming/c-function-printf.html)。
